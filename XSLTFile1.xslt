...
>
    ...
    <xsl:template match="Adresar">
      <html>
        <head>
          <title> Osobe i kompanije koje imaju više od dve email adrese</title>  
        </head>
        <body>
          <table border="1" cellpadding="10">
            ...
            <tbody>
              <xsl:apply-templates select="Osoba"></xsl:apply-templates>
            </tbody>
          </table>
          <br/>
          <table border="1" cellpadding="10">
            ...
            <tbody>
              <xsl:apply-templates select="Kompanija"></xsl:apply-templates>
            </tbody>
          </table>
      </body>
      </html>
